...
SECRET_KEY = '(m3t52@geq9966ey8sdn3ujkzl(&c71j%$2$svqpxp0pn=su(_'
...
STATIC_ROOT = os.environ['HOME'] + '/webapps/router/nginx/html/static/'

user = getpass.getuser()
use_debug = user != 'vbcoder'
